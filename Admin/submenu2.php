...
<li><a class="submenu" href="table4.php"><i class="icon-file-alt"></i><span class="hidden-tablet"> Package table </span></a></li>
      ...
      <div class="container">
        ...
        <div class="panel-heading"><center><font size='4'>▼&nbsp;&nbsp;&nbsp;   Employees &nbsp;&nbsp;&nbsp;▼</font></center></div>
        <!-- Table -->
        <table class="table" border='2' border-color='blue'>
            <?php
            echo "<th bgcolor=yellow>ID </th>";
            echo "<th bgcolor=yellow>Name ▼</th>";
            echo "<th bgcolor=yellow>Email ▼</th>";
            echo "<th bgcolor=yellow>Mobile ▼</th>";
            echo "<th bgcolor=yellow>National ID ▼</th>";
           
            //Do the query
            $query = "SELECT * FROM users where rank<>5";

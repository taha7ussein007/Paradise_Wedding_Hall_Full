...
<div class="navbar-inner">
        ...
        <li class="dropdown">
                <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="halflings-icon white user"></i> Technical Name
...
echo "
<form action='submenu2.php' method='POST' name='updateinfo'>";
$query = @ mysql_query('select * form users  where id="'.$_SESSION['id'].'"');
...
<tr>
<td> <input type='text' name='mobi' size='20'>    </td>
<td> <input type='email' name='email' size='5'>     </td>
</tr>
</table>
...
<tr>
<td colspan='2'><input style= ' background-color: #008080;  color: #E0FFFF; ' type='submit' name='submit' value='Update'></td>
</tr>
</table>
</form>
...
if($oldpass != NULL){
    ...
    if($newpass !=NULL){
             mysql_query("update users set password='$newpass'  where password='$oldpass'" );   //note
                     echo "<meta http-equiv='refresh' content='0' >";

    }
    if($mobi != NULL){
       mysql_query("update users set  mob='$mobi'  where  password='$oldpass'");   //note
               echo "<meta http-equiv='refresh' content='0' >";

    }

if($emai != NULL){
      mysql_query("update users set email='$emai'  where password='$oldpass'");   //note
              echo "<meta http-equiv='refresh' content='0' >";

...
<head>
	<meta charset="UTF-8">
	<title>Blog - Paradise Wedding Hall</title>
				...
				<div>
					<div>
						...
						<p>This website has been developed by
							<a href="#">CSweepers Team From FCIH</a>
							as a Software Engineering Course 's project, it is a PHP MVC project based on SQL Database , this project based on different roles
							Admin , Financial , Manager , Technical , User and Visitor every role has different functionality and special design 
                                                        For Using this website & to see full functionality please Login as different role</p>
                                                <b><br/>How To Use it</b>. 

                                                <pre>   Using :-                   Username                Password            </pre>    
                                                <pre>      Admin :                 admin@admin               admin            </pre>
                                                <pre>      Technical :             tech@tech                 tech             </pre>
                                                <pre>      Financial :             finan@finan               finan            </pre>
                                                <pre>      User :                   user@user                user            </pre>
                                                            
                                                            NOTICE : Simply if you made an account you would be a user all others are put by admin.
					...
					<div>
						...
						<div>
							<ul>
								<li>
									<a href="blog.php">Phasellus luctus dui etien or nisi porta</a>
								</li>
								<li>
									<a href="blog.php">Integer congue varius enucio odio vitae</a>
								</li>
								<li>
									<a href="blog.php">Aliquam congue lacinia vehicula eur</a>
								</li>
								<li>
									<a href="blog.php">Lectus quis egestas dapibus lorem</a>
								</li>
								<li>
									<a href="blog.php">Lorem imperdiet ipsum iaculis empor</a>
								</li>
								<li>
									<a href="blog.php">Sed convallis purus vitae sem molestie</a>
								</li>
								<li>
									<a href="blog.php">Fusce consectetur sodales erat unt drid</a>
								</li>
								<li>
									<a href="blog.php">Suscipit in tortor ligula suscipit lorem</a>
								</li>
								<li>
									<a href="blog.php">Proin consectetur diam nec lectus sagit</a>
								</li>
								<li>
									<a href="blog.php">Tristique lacus fermentum lorem ai quis</a>
								</li>
								<li>
									<a href="blog.php">Aenean ultricies ante acto delit luctus</a>
								</li>
								<li>
									<a href="blog.php">Fusce gravida tincidunt lectus age nec</a>
								</li>
								<li>
									<a href="blog.php">Nulla velit erat luctus at cursus dignis</a>
								</li>
							</ul>
						</div>
					</div>
